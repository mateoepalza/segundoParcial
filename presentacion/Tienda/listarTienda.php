...
<script type="text/javascript">
    $(function() {
        ...
        $.post("indexAJAX.php?pid=<?php echo base64_encode("Presentacion/Tienda/Ajax/searchBarTienda.php") ?>", json, function(data) {
            console.log(data);
            res = JSON.parse(data);
    ...
    $(function() {
        ...
        $("#tabla").on('click', ".moreInfoBtn", function() {
            $url = "indexAJAX.php?pid=<?php echo base64_encode("Presentacion/Tienda/Ajax/searchBarTienda.php") ?>&idCliente=" + $(this).data("idcliente");
            $(".modal-body").load($url);
        });
            ...
            $("#tabla").append(
                `<tr>
                    ...
                    <td style='display:flex; justify-content:center;'>
                        <a href="reporteTienda.php?idTienda=${data[0]}" target="__black" ><i class="far fa-file"></i></a>
                    </td>
                </tr>`
            );
        });
